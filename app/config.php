...
// +---------------------------------------------------------------------------+
// AgaviConfig::set('core.agavi_dir', '/var/www/earthexplorer.info/libs/agavi');
...
$currentPath .= PATH_SEPARATOR.realpath(dirname(__FILE__).'/../libs');
$currentPath .= PATH_SEPARATOR.realpath(dirname(__FILE__).'/lib');
ini_set('include_path', $currentPath);
//die($currentPath);
